...
#import "Player4Controller.h"

@interface Player4Controller ()
...
@implementation Player4Controller
...
- (void)fullScreen{
    [UIView animateWithDuration:.5f animations:^{
        ...
        if ([[UIDevice currentDevice] orientation] == UIDeviceOrientationLandscapeRight || [[UIDevice currentDevice] orientation] == UIDeviceOrientationLandscapeLeft) {
            [self rotateDevice:[[UIDevice currentDevice] orientation]];
        }else{
            [self rotateDevice:UIDeviceOrientationLandscapeLeft];
        }
